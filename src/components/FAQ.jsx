...
const faqs = [
  ...
  { q: "Quelles sont vos zones d'intervention ?", a: "La vallée de Chamonix et la Haute-Savoie pour l'agencement. Pour le mobilier transportable, je peux intervenir plus largement, parlons-en." },
